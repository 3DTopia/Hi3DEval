...
output_dir = os.path.dirname(__file__)  # output dir

# ========================= input ==========================
num_frames = 16                  # changed
num_frames_test = 16             # changed
batch_size = 16
batch_size_test = 48
max_txt_l = 32
...
scheduler = dict(sched="cosine", epochs=4, min_lr_multi=0.01, warmup_epochs=0.6)
